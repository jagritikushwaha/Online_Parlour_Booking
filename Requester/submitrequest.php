...
<div   class="col-sm-9 col-md-10 mt-5"><!-- start service Request form-->
  <form class="mx-5" action="submitrequest.php" method="get">
    ...
    <button type="submit" class="btn btn-danger" name="submitrequest" style="margin-left:10px; margin-top:10px;">Submit</button>
    <button type="reset" class="btn btn-secondary"style=" margin-top:10px; margin-left:10px;">Reset</button>
